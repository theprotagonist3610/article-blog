...
export default function Article({ data, categories, all }) {
  const returnPrevNext = () => {
    ...
    all.map((el, index) => {
      if (el.url === data.url) {
        ...
        all[index + 1] ? (next = all[index + 1]) : (next = all[0]);
      }
    });
    return { prev, next };
  };
  ...
  return (
    <>
      <Head>
        <title>Tout est NET : {data.titre}</title>
      ...
      <main className="main">
        ...
        <div id="frontground">
          ...
          <div id="article-phone"></div>
          <div id="article-computer">
            <div id="article-computer-content">
              <div
                id="article-header"
                style={{
              ...
              >
                <div></div>
                <div></div>
                <div id="article-titre">{data.titre}</div>
                <div id="article-details">
                  <div id="article-author">{data.auteur}</div>
                  <div id="article-date">{data.datestamp}</div>
              ...
              <div id="article-sommaire">
                <div style={{ fontSize: "1.2rem" }}>Sommaire</div>
                <ol>
                  {data?.sections?.map((el, index) => (
                    <li key={index}>
                      <a
                        className="liste-sommaire"
                        href={`#section-paragraphe-${index}`}
                      >
                        {el.titre}
                      </a>
                    </li>
              ...
              <div id="article-bottom">
                ...
                >
                  ...
                  >
                    <div>{returnPrevNext().prev.titre}</div>
                    <div>&larr;</div>
                  </div>
                </a>
                <a
                ...
                >
                  ...
                  >
                    <div>{returnPrevNext().next.titre}</div>
                    <div>&rarr;</div>
                  </div>
                </a>
              </div>
